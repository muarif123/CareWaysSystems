...
export const signup = createAsyncThunk('signup/api',async(obj)=>{
    var response = await axios.post('https://node.cws.com.pk/api/signupinfo',obj)
    return response.data
})
export const login = createAsyncThunk('login/api',async(obj)=>{
    var response = await axios.post('https://node.cws.com.pk/api/logininfo',obj)
    return response.data
})
export const uploads =createAsyncThunk('uploads/api',async(obj)=>{
    console.log(obj.formData,'product');
    var response = await axios.post('https://node.cws.com.pk/api/productinfo',obj.formData,{
        headers:{
...
export const getproducts = createAsyncThunk('getproducts/api',async()=>{
    var response = await axios.get('https://node.cws.com.pk/api/getproductinfo')
    return response.data
})

export const addtocart = createAsyncThunk('addtocart/api',async(obj)=>{
    var response = await axios.post('https://node.cws.com.pk/api/addcart',obj.item,{
       headers:{
        Authorization:`Bearer: ${obj.token}`
       }
    })
...
export const getcart = createAsyncThunk('getcart/api',async(obj)=>{
    ...
    var response = await axios.get(`https://node.cws.com.pk/api/getcartpr/${obj._id}`)
    return response.data
})
export const getcart2 = createAsyncThunk('getcart2/api',async()=>{
   

    var response = await axios.get('https://node.cws.com.pk/api/getcartotal')
    return response.data
})
export const deletion = createAsyncThunk('deletion/api',async(obj)=>{
    console.log(obj.token,'deletion');
    var response = await axios.post(`https://node.cws.com.pk/api/deletes/${obj.itemId}`,{},{
        headers:{
            Authorization:`Bearer: ${obj.token}`
        }
    })
...
export const clearcart = createAsyncThunk('clearcart/api',async(obj)=>{
    ...
    var response = await axios.get(`https://node.cws.com.pk/api/clearcartpr/${obj._id}`)
    return response.data
...
export const  deleteprod = createAsyncThunk('deleteprod/api',async(obj)=>{
    console.log(obj.token,'deletion');
    var response = await axios.post(`https://node.cws.com.pk/api/deleteproduc/${obj.itemid}`,{},{
        headers:{
            Authorization:`Bearer: ${obj.token}`
        }
    })
...
export const changer = createAsyncThunk('changer/api',async(obj)=>{
    var response = await axios.post('https://node.cws.com.pk/api/changepas',obj.formdata,{
        headers:{
            Authorization:`Bearer: ${obj.token}`
        }
    })
...
export const updatepass = createAsyncThunk('updatepass/api',async(obj)=>{
    console.log(obj);
    var response = await axios.put('https://node.cws.com.pk/api/updatepasser',obj)
    return response.data
})
export const edits = createAsyncThunk('edits/api',async(obj)=>{
    console.log(obj,'tobeedit');
    var response = await axios.put(`https://node.cws.com.pk/api/updateproduct/${obj.index}`,obj.editpro,{
        headers:{
            Authorization:`Bearer: ${obj.token}`
        }
    })
...
export const updateimg1 = createAsyncThunk('updateimg1/api',async(obj)=>{
    ...
    var response = await axios.put(`https://node.cws.com.pk/api/updateimage1/${obj.index}`,obj.formData2,{
        headers:{
            Authorization:`Bearer: ${obj.token}`
        }
    })
...
export const updateimg2 = createAsyncThunk('updateimg2/api',async(obj)=>{
    ...
    var response = await axios.put(`https://node.cws.com.pk/api/updateimage2/${obj.index}`,obj.formData3,{
        headers:{
            Authorization:`Bearer: ${obj.token}`
        }
    })
...
export const updateimg3 = createAsyncThunk('updateimg3/api',async(obj)=>{
    ...
    var response = await axios.put(`https://node.cws.com.pk/api/updateimage3/${obj.index}`,obj.formData4,{
        headers:{
            Authorization:`Bearer: ${obj.token}`
        }
    })
...
export const getprdetail = createAsyncThunk('prdetail/api',async(index)=>{
    var response = await axios.get(`https://node.cws.com.pk/api/getonedetail/${index}`)
    return response.data
})
export const getrelated = createAsyncThunk('getrelated/api',async(index)=>{
  
    var response = await axios.get(`https://node.cws.com.pk/api/getcatego/${index}`)
    return response.data
})
...
export const searching = createAsyncThunk('searching/api',async(value)=>{
    ...
    var response = await axios.get(`https://node.cws.com.pk/api/getquery/${value}`)
    console.log(response.data,'queryresulta');
    return response.data
})
export const filte = createAsyncThunk('filte/api',async(value)=>{
    console.log(value,'value');
    var response = await axios.get(`https://node.cws.com.pk/api/getcateg/${value}`)
    console.log(response.data,'queryresulta');
    return response.data
})
export const uploadcar = createAsyncThunk('uploadcar/api',async(obj)=>{
    console.log(obj,'obj');
    var response = await axios.post('https://node.cws.com.pk/api/sendcar',obj)
    return response.data
    

})
export const getcarousel = createAsyncThunk('getcarousel/api',async()=>{
    var response = await axios.get('https://node.cws.com.pk/api/sendcarousels')
    return response.data
})
export const sendedcar = createAsyncThunk('sendedcar/api',async(obj)=>{
    console.log(obj,'obj');
    var response = await axios.put(`https://node.cws.com.pk/api/geteditcar/${obj.index}`,obj.formdata)
    return response.data
    

})
export const getusersi = createAsyncThunk('getusersi/api',async()=>{
    var response = await axios.get('https://node.cws.com.pk/api/getuserinfos')
    return response.data
})
export const updatestatus = createAsyncThunk('updatestatus/api',async(obj)=>{
    console.log(obj);
    var response = await axios.put('https://node.cws.com.pk/api/updatestat',obj)
    return response.data
})
export const getlinks = createAsyncThunk('getlinks/api',async(obj)=>{
    console.log(obj);
    var response = await axios.post('https://node.cws.com.pk/api/passmail',obj)
    return response.data
})
