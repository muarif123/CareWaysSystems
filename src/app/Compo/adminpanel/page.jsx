...
const AdmPanel = () => {
  ...
  function sendata() {
    if (!name || !price || !category || !image1 || !image2 || !image3) {
  ...
  return (
    <div className="w-full dark:bg-customGray">
      <div className="w-11/12 sm:w-11/12 md:w-10/12 xl:w-7/12 2xl:w-7/12 py-10 mx-auto">
        ...
        <div
          className="rounded-lg dark:bg-customGray border bg-card text-card-foreground shadow-sm"
          data-v0-t="card"
        >
          ...
          <div className="p-6 grid gap-4 md:gap-6">
            ...
            <div className="grid gap-2">
              ...
              <input
                ...
                className="flex h-10 bg-transparent rounded-md border border-input  px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-24"
                id="price"
            ...
            <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <textarea
                  ...
                  style={{ height: "100px" }}
                  className="flex w-full bg-transparent rounded-md border border-input  px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                  id="description"
